...
/**
 * A classe {@link DatabaseTestConfig}contem a definicoes de <i>beans</i> do
 * Spring referentes a configuracao de base de dados para testes de integracao.
 *
...
@Profile("test")
@Configuration
@PropertySource("classpath:/br/gov/sp/fatec/mapskills/account/config/datasource.properties")
public class DatabaseTestConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(final DataSource dataSource,
        ...
        emfb.setPersistenceUnitName("ACCOUNTPersistenceUnit");
        emfb.setPersistenceXmlLocation("classpath*:/br/gov/sp/fatec/mapskills/account/config/persistence.xml");
        return emfb;
    }
